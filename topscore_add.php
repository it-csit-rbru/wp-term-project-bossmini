        ...
        <a class="nav-link" href="scoretable_list.php">ตารางคะแนน</a>
                    ...
                    <?php
                        ...
                        if(isset($_GET['submit'])){
                            ...
                            $sql .= " values (null,'$player_name','$player_club','$player_score','$player_title_id'";
                            echo $sql;
                            include 'connectdb.php';
                            mysqli_query($conn,$sql);
                            mysqli_close($conn);
                            echo "เพิ่มนักฟุตบอล $player_name  เรียบร้อยแล้ว<br>";
                            echo '<a href="topscore_list.php">แสดงรายชื่อนักฟุตบอลทั้งหมด</a>';
                        }else{
                    ?>
                    <form class="form-horizontal" role="form" name="score_add" action="<?php echo $_SERVER['PHP_SELF'];?>">
