...
<?php
                         ...
                         if(isset($_GET['submit'])){
                            ...
                            mysqli_close($conn);
                            echo "แก้ไขตารางคะแนน $data_en $data_th  เรียบร้อยแล้ว<br>";
                    ...
                    <form class="form-horizontal" role="form" name="datateam_edit" action="<?php echo $_SERVER['PHP_SELF']?>">
                        ...
                        <input type="hidden" name="data_id" id="data_id" value="<?php echo "$fdata_id";?>">
                        <div class="form-group">
                            <label for="Money_name" class="col-md-2 col-lg-2 control-label">แข่ง</label>
                            <div class="col-md-10 col-lg-10">
                        ...
                        <input type="hidden" name="data_id" id="data_id" value="<?php echo "$fdata_id";?>">
                        <div class="form-group">
                            <label for="Money_name" class="col-md-2 col-lg-2 control-label">ชนะ</label>
                            <div class="col-md-10 col-lg-10">
                            <input type="text" name="" id="" class="form-control" value="<?php echo "";?>">                            </div>    
                        </div>
                        <form class="form-horizontal" role="form" name="datateam_edit" action="<?php echo $_SERVER['PHP_SELF']?>">
                        <input type="hidden" name="data_id" id="data_id" value="<?php echo "$fdata_id";?>">
                        <div class="form-group">
                            <label for="Money_name" class="col-md-2 col-lg-2 control-label">เสมอ</label>
                            <div class="col-md-10 col-lg-10">
                            <input type="text" name="" id="" class="form-control" value="<?php echo "";?>">                            </div>    
                        </div>
                        <form class="form-horizontal" role="form" name="datateam_edit" action="<?php echo $_SERVER['PHP_SELF']?>">
                        <input type="hidden" name="data_id" id="data_id" value="<?php echo "$fdata_id";?>">
                        <div class="form-group">
                            <label for="Money_name" class="col-md-2 col-lg-2 control-label">แพ้</label>
                            <div class="col-md-10 col-lg-10">
                            <input type="text" name="" id="" class="form-control" value="<?php echo "";?>">                            </div>    
                        </div>
                        <form class="form-horizontal" role="form" name="datateam_edit" action="<?php echo $_SERVER['PHP_SELF']?>">
                        <input type="hidden" name="data_id" id="data_id" value="<?php echo "$fdata_id";?>">
                        <div class="form-group">
                            <label for="Money_name" class="col-md-2 col-lg-2 control-label">ลูกได้</label>
                            <div class="col-md-10 col-lg-10">
                            <input type="text" name="" id="" class="form-control" value="<?php echo "";?>">                            </div>    
                        </div>
                        <form class="form-horizontal" role="form" name="datateam_edit" action="<?php echo $_SERVER['PHP_SELF']?>">
                        <input type="hidden" name="data_id" id="data_id" value="<?php echo "$fdata_id";?>">
                        <div class="form-group">
                            <label for="Money_name" class="col-md-2 col-lg-2 control-label">ลูกเสีย</label>
                            <div class="col-md-10 col-lg-10">
                            <input type="text" name="" id="" class="form-control" value="<?php echo "";?>">                            </div>    
                        </div>
                        <form class="form-horizontal" role="form" name="datateam_edit" action="<?php echo $_SERVER['PHP_SELF']?>">
                        <input type="hidden" name="data_id" id="data_id" value="<?php echo "$fdata_id";?>">
                        <div class="form-group">
                            <label for="Money_name" class="col-md-2 col-lg-2 control-label">รวม ได้/เสีย</label>
                            <div class="col-md-10 col-lg-10">
                            <input type="text" name="" id="" class="form-control" value="<?php echo "";?>">                            </div>    
                        </div>
                        <form class="form-horizontal" role="form" name="datateam_edit" action="<?php echo $_SERVER['PHP_SELF']?>">
                        <input type="hidden" name="data_id" id="data_id" value="<?php echo "$fdata_id";?>">
                        <div class="form-group">
                            <label for="Money_name" class="col-md-2 col-lg-2 control-label">คะแนน</label>
                            <div class="col-md-10 col-lg-10">
                            <input type="text" name="" id="" class="form-control" value="<?php echo "";?>">                            </div>    
                        </div>
